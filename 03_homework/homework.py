...
def train_model(df, categorical, date):
    ...
    with mlflow.start_run():
        ...
        # mlflow.log_artifact(f"models/dv-{date}.b", artifact_path=f"dv-{date}.b")
        # mlflow.sklearn.log_model(lr, artifact_path=f"model-{date}.bin")
    return lr, dv
...
def main(date=None):
    ...
    mlflow.set_experiment('first_prefect_flow')
